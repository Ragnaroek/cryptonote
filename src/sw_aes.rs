...
pub fn aes_round(block: u64x2, key: u64x2) -> u64x2 {
    let x0 = sse::_mm_cvtsi128_si32(block);
    let x1 = sse::_mm_cvtsi128_si32(sse::_mm_shuffle_epi32_0x55(block));
